...
const About = ({theme}) => {
  ...
  return (
    <div className='about'>
      ...
      and simple design principles. It shows our desire
      to contribute positively to our university and leave something helpful.<br/>
      If you notice a bug, a display issue, or if you have a suggestion, report it here, it helps us to improve the site and make it even better.
      </p>
      ...
      <div style={{marginTop: 24, textAlign: 'center'}}>
        <span style={{fontSize: '1rem', color: '#666'}}>you can also take a look here...</span>
        <br/>
